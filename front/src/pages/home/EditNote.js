        ...
        <div className="edit-note-wrapper">
            ...
            {note != undefined && <div className="card showing h-100">
                <div className="v-spacer-s flex center gap-xs">
                    ...
                    <button className="surface-button gap-xs flex center" onClick={() => onDiscardCallback()}>
                    ...
                    <button className="solid-accent-button gap-xs flex center" style={{paddingRight:'16px'}} onClick={save}>
